...
window.questions = {
    male: {
        ...
        flirty: [
            ...
            { text: "我會在戀愛中保持其他曖昧對象", type: "flirty" },
            { text: "我會在戀愛中保持多個備胎", type: "flirty" },
            { text: "我經常對不同的人說一樣的甜言蜜語", type: "flirty" },
            { text: "我會跟朋友炫耀自己同時交往多少人", type: "flirty" },
            { text: "我覺得感情不順利時可以同時接觸其他人", type: "flirty" },
            { text: "我會在社交軟體上和異性曖昧聊天", type: "flirty" },
            { text: "我經常在社交媒體上隱瞞自己的感情狀態", type: "flirty" },
            { text: "我曾經在戀愛中出軌", type: "flirty" },
            { text: "我會在分手後立即開始新的戀情", type: "flirty" }
        ],

        // 冷漠型渣男的特徵問題
        cold: [
            { text: "我會在戀愛中保持距離，不願意承諾", type: "cold" },
            { text: "我經常在戀愛中忽冷忽熱", type: "cold" },
            { text: "我會在戀愛中保持若即若離的態度", type: "cold" },
            { text: "我不會主動關心對方的生活狀況", type: "cold" },
            { text: "我不會特別記得對方的生日或紀念日", type: "cold" },
            { text: "我經常以工作忙為藉口不陪伴對方", type: "cold" },
            { text: "我會在交往期間刻意不回覆對方的訊息", type: "cold" },
            { text: "我不會在意對方的感受就做決定", type: "cold" },
            { text: "我會故意不接對方的電話製造神秘感", type: "cold" },
            { text: "我不會真誠地跟對方溝通問題", type: "cold" }
        ],
        ...
        scammer: [
            ...
            { text: "我會在戀愛中保持神秘感，不願意透露太多", type: "scammer" },
            { text: "我不會告訴現任關於我和前任的事情", type: "scammer" },
            { text: "我會刻意不讓對方認識我的朋友圈", type: "scammer" },
        ...
        // 控制型渣男的特徵問題
        controller: [
            { text: "我會在吵架時提起對方的過去傷害他/她", type: "controller" },
            { text: "我經常用分手來威脅對方就範", type: "controller" },
            { text: "我會因為一點小事就威脅要分手", type: "controller" },
            { text: "我經常拿其他異性來刺激對方", type: "controller" },
            { text: "我會在感情中故意製造不安全感", type: "controller" },
            { text: "我會因為一時心情不好就對對方發脾氣", type: "controller" },
            { text: "我經常把自己的錯誤歸咎於對方", type: "controller" },
            { text: "我會因為對方不夠完美就想分手", type: "controller" },
            { text: "我會跟朋友分享對方的私密事情", type: "controller" },
    ...
    female: {
        ...
        // 騙錢型渣女的特徵問題
        scammer: [
            { text: "我會要求對方買名牌包包或奢侈品", type: "scammer" },
            { text: "我覺得男生就應該要請客買單", type: "scammer" },
            { text: "我會用生氣來要求對方送禮物", type: "scammer" },
            { text: "我經常暗示對方要送我貴重禮物", type: "scammer" },
            { text: "我會拿其他人送的禮物來比較", type: "scammer" },
            { text: "我覺得男生的價值在於他能給我什麼", type: "scammer" },
            { text: "我會因為對方的經濟條件而考慮分手", type: "scammer" },
            { text: "我經常跟對方借錢但不還", type: "scammer" },
            { text: "我會用感情來要求對方在經濟上支持我", type: "scammer" },
            { text: "我覺得感情就是一種交易關係", type: "scammer" }
        ],

        // 控制型渣女的特徵問題
        controller: [
            { text: "我會要求對方隨時回報行蹤", type: "controller" },
            { text: "我會檢查對方的手機和社交軟體", type: "controller" },
            { text: "我會限制對方和異性來往", type: "controller" },
            { text: "我經常懷疑對方出軌或劈腿", type: "controller" },
            { text: "我會要求對方刪除異性好友", type: "controller" },
            { text: "我會因為吃醋而大發脾氣", type: "controller" },
            { text: "我會限制對方的社交活動", type: "controller" },
            { text: "我會威脅自殘來控制對方", type: "controller" },
            { text: "我會用眼淚來操控對方", type: "controller" },
        ...
        liar: [
            ...
            { text: "我會說不用送禮物但其實很期待", type: "liar" },
            { text: "我會說「沒事」但其實很生氣", type: "liar" },
            { text: "我經常說反話測試對方", type: "liar" },
            { text: "我會刻意表現出不在意的樣子", type: "liar" },
            { text: "我會期待對方讀懂我的心思", type: "liar" },
            { text: "我會因為對方沒察覺我的暗示而生氣", type: "liar" },
            { text: "我經常說「不用了」但希望對方堅持", type: "liar" },
            { text: "我會用沉默來表達不滿", type: "liar" },
